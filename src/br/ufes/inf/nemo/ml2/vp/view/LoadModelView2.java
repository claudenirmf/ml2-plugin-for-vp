package br.ufes.inf.nemo.ml2.vp.view;
...
public class LoadModelView2 implements IDialogHandler {
	...
	public Component getComponent() {
		...
		ActionListener loadAction = new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				_dialog.close();
				String folderPath = _path.getText();
				VPModelAccess.load();
//				ML2ModelLoader.clear();
				ML2ModelLoader.loadModel(folderPath);
				ML2ModelLoader.feed();
